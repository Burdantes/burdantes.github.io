...
<div class="projects-page">
  ...
  <section class="projects-section">
    ...
    <article class="project-row">
      <h3>RevTr Animated Explanation</h3>
      <div>
        <p>Interactive scenarios explaining how RevTr reconstructs reverse Internet paths, why spoofing matters, and how ambiguous intersections are handled.</p>
        <div class="project-links">
          <a href="/projects/revtr/">Project page</a>
          <a href="/assets/revtr/revtr_scenarios.html" target="_blank" rel="noopener noreferrer">Full animation</a>
        </div>
      </div>
    </article>
