...
description: Archived project descriptions (Internet Measurement, Geopolitics, Manifold).
nav: false
---
...
<div style="margin-bottom: 40px;">
  <h1 style="color: #2c3e50; font-weight: 300; font-size: 2.2em; letter-spacing: -0.5px; margin: 0 0 10px 0; border-bottom: 2px solid #2c3e50; padding-bottom: 10px;">Projects (Archive)</h1>
</div>
