...
description: Why there is now a blog here, and what I intend to put in it.
tags: meta
categories: academia
...
<!--
  ---------------------------------------------------------------------------
  FRONT MATTER REFERENCE  (delete this comment in real posts)

  Required
    layout: post
    title: <post title>
    date: YYYY-MM-DD HH:MM:SS-0400     # -0400 EDT / -0500 EST
    description: <one line; shows on the Notes index and in the RSS feed>

  Filing
    categories: academia | papers | experiments   # pick ONE; these are the
                                                  # three filters on /blog/
    tags: free-form space-separated               # e.g. tags: bgp measurement

  Optional switches
    giscus_comments: true          # comment thread at the bottom
    related_posts: false           # hide the "related" footer (default: shown)
    toc:
      sidebar: left                # sticky table of contents; use for long posts
    featured: true                 # pin to the top of the Notes index

  Writing extras — see _drafts/README.md for a worked example of each:
    math, figures, code blocks, Jupyter notebooks, TikZ/mermaid diagrams,
    per-post bibliographies, callout blockquotes.
  ---------------------------------------------------------------------------
-->
